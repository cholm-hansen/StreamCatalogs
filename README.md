...
Welcome! This is a guide for the stellar stream catalogs from Holm-Hansen, Chen, & Gnedin (2025). Specifically, this repository contains information on the contents of the catalogs, and how to download them. A jupyter notebook `example.ipynb` is provided which shows how to load in one of the catalogs and perform some simple calculations with them. 
...
- C. Holm-Hansen, Y. Chen, & O.Y. Gnedin (2025). *Catalog of Mock Stellar Streams in Milky Way-like Galaxies*. OJAp, 9 [(ADS link)](https://ui.adsabs.harvard.edu/abs/2025arXiv251009604H/abstract) [(OJAp link)](https://astro.theoj.org/article/159598-catalog-of-mock-stellar-streams-in-milky-way-like-galaxies)
